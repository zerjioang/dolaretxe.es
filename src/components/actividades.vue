<template>
  <div>
    <pagetitle  v-show="showPageTitle" page="Actividades"/>
            ...
            <div class="row no-gutters">
               <div class="col-md-12 wrap-about ftco-animate">
                  <div class="heading-section mb-5 pt-5 pl-md-5">
                    ...
                    <div class="row">
                      <div class="col-xs-6 col-md-6 col-lg-3" v-for="item in desarrolloList" :key="item.id">
                     ...
                     <!-- end cta desarrollo -->
                     <p class="justified">De este modo conseguiremos un adecuado desarrollo de los niños en los siguientes aspectos:</p>
                     <ul>
                       <li>
               ...
               <div class="col-md-12 wrap-about ftco-animate">
                  <div class="heading-section pl-md-5">
                     ...
                     <p class="justified">
                        A través del juego conseguimos un ambiente agradable, divertido e integrador lleno de momentos placenteros que favorecen el aprendizaje y hacen que el niño eleve su autoestima, y se sienta querido y seguro.
                     </p>
                     <p class="justified">
                        Con el juego logramos que los niños:
                     </p>
                     <ul>
                     ...
                     <p class="justified">
                       Hacemos un seguimiento personalizado y diario de cada niño. Informamos a las familias diariamente de forma oral y a través de la agenda escolar sobre la educación y evolución de los niños.
                     </p>
                     <p class="justified">
                      Evaluamos trimestralmente la evolución de los niños con boletines de información.
                     </p>
                    ...
                    <div class="pr-md-5 mr-md-5">
                     ...
                     <p class="justified">
                       Nos centramos en las siguientes actividades para lograr un desarrollo armónico de acuerdo a cada una de las edades y ritmos de cada uno de los niños.</strong>.
                     </p>
                    </div>
               ...
               <div class="col-md-6">
                 <ul>
                  <li>Estimulación del lenguaje en las diversas áreas de expresión mediante cuentos, canciones y rimas.
                  </li>
