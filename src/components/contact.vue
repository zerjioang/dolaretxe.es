            ...
            <div class="row no-gutters">
               <div class="col-md-12 ftco-animate">
                  <div class="heading-section">
                     ...
                     <img class="col-md-6 image-popup img img-resposive img-example" :src="insta01" :href="insta01"/>
                     <img class="col-md-6 image-popup img img-resposive img-example" :src="insta02" :href="insta02"/>
            ...
            <div class="row no-gutters">
             ...
             <div class="row no-gutters" style="margin-bottom: 30px">
               <div class="col-md-6 ftco-animate text-center fadeInUp ftco-animated">
                   <img class="location-img text-center" :src="require('@/assets/images/reference_image.png')">
               </div>
