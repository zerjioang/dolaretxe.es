            ...
            <div class="row no-gutters">
               <div class="col-md-12 ftco-animate">
                  <div class="heading-section">
                     ...
                     <img class="col-md-6 image-popup img img-resposive img-example" :src="insta01" :href="insta01" alt="dolaretxe escuela Infantil, haur eskola y guarderia en bilbao"/>
                     <img class="col-md-6 image-popup img img-resposive img-example" :src="insta02" :href="insta02" alt="dolaretxe escuela Infantil, haur eskola y guarderia en bilbao"/>
            ...
            <div class="row no-gutters">
             ...
             <div class="row no-gutters" style="margin-bottom: 30px">
               <div class="col-md-6 ftco-animate text-center fadeInUp ftco-animated">
                   <img class="location-img text-center" :src="require('@/assets/images/reference_image.png')" alt="dolaretxe escuela Infantil, haur eskola y guarderia en bilbao">
               </div>
               <div class="col-md-6 ftco-animate text-center fadeInUp ftco-animated mt-4">
                 <p class="justified">
                    Escuela Infantil Haur Eskola (<a href="https://goo.gl/maps/8NV7Twm7ARWWiPLDA" target="blank" rel="noopener">Ver en Google Maps</a>)
                    </br>
               ...
               <div class="col-md-12 ftco-animate text-center fadeInUp ftco-animated mt-4">
                 ...
                 <div class="row">
                   <div class="col-xs-12 col-sm-12 col-md-4 ftco-animate">
                    <img class="location-icon" :src="require('@/assets/images/metrobilbao.png')" alt="dolaretxe escuela Infantil, haur eskola y guarderia en bilbao">
                   ...
                   <div class="col-xs-12 col-sm-12 col-md-4 ftco-animate">
                    <img class="location-icon-svg" :src="require('@/assets/images/elevator.svg')" alt="dolaretxe escuela Infantil, haur eskola y guarderia en bilbao">
                   ...
                   <div class="col-xs-12 col-sm-12 col-md-4 ftco-animate">
                    <img class="location-icon-svg" :src="require('@/assets/images/street.svg')" alt="dolaretxe escuela Infantil, haur eskola y guarderia en bilbao">
